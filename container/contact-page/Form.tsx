				...
				<div className="w-full flex gap-[15px] sm:flex-col xm:flex-col">
					<div className="flex gap-[10px] w-[50%] sm:w-full xm:w-full sm:flex-col xm:flex-col">
						<div className="xl:min-w-max lg:min-w-max md:min-w-max">
							<h2 className="sub-heading font-Formiga font-light text-secondry">
								Hi! My name is
							</h2>
						</div>
						<div className="w-full">
							<input
								...
								className="paragraph w-full font-Formiga font-light text-secondry bg-background border-b border-[#21212155] focus:border-secondry text-center sm:text-left xm:text-left outline-none focus:placeholder:opacity-0 mt-[20px] transform transition duration-200 ease-in-out sm:w-full xm:w-full"
							/>
						</div>
					</div>
					<div className="flex gap-[10px] w-[50%] sm:w-full xm:w-full sm:flex-col xm:flex-col">
					...
					<div className="flex gap-[10px] w-full sm:flex-col xm:flex-col">
						...
						<div className="w-full">
							<input
								...
								className="paragraph font-Formiga font-light text-secondry bg-background border-b border-[#21212155] focus:border-secondry text-center sm:text-left xm:text-left outline-none focus:placeholder:opacity-0 mt-[20px] transform transition duration-200 ease-in-out w-full sm:w-full xm:w-full"
							/>
						</div>
					</div>
				</div>
					...
					<div className="flex gap-[10px] items-center">
						<div className="flex gap-[10px]">
							<input
								...
								className="w-[30px]"
							/>
							<p className="paragraph text-secondry font-Formiga font-light">
								I agree with the
							</p>
						</div>
						<Link
							className="paragraph font-medium font-Formiga text-secondry capitalize flex flex-col hover"
							href={"/privacy"}>
							Privacy Policy
						</Link>
					</div>
