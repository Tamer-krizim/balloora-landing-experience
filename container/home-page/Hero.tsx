		...
		<section
			...
			<div className="w-full h-full flex flex-col justify-between">
				...
				<div className="w-full flex flex-col justify-between h-[75vh] sm:h-[85vh] xm:h-[85vh]">
					...
					<div className="w-full flex flex-col h-[22vh] border-t border-secondry py-[20px] sm:mb-[80px] xm:mb-[80px] gap-[30px]">
						<div className="flex justify-between items-center padding-x gap-[20px] sm:flex-col sm:items-start xm:flex-col xm:items-start">
							...
							<div className="w-[50%] xm:w-full sm:w-full flex justify-between xm:flex-col xm:items-start sm:flex-col sm:items-start gap-[20px]">
								...
								<div className="flex items-center gap-[5px] group">
									<div className="rounded-[50px] border border-[#21212199] group-hover:bg-[#AEEC7A] group-hover:border-[#AEEC7A]  py-[3px] px-[12px] cursor-pointer">
										<Link
											className="paragraph font-Formiga text-secondry uppercase group-hover:text-secondry transition-all  transform duration-[0.3s] ease-[.215,.61,.355,1]"
											href="/contact">
											start the project
										</Link>
									</div>
									<div className="w-[33px] flex items-center justify-center h-[33px] border border-secondry rounded-full p-[1px] sm:p-[30px] xm:pb-[30px]  group-hover:bg-[#AEEC7A] group-hover:border-[#AEEC7A] transition-all transform duration-[0.3s] ease-[.215,.61,.355,1] cursor-pointer xm:hidden sm:hidden">
										<p className="font-normal text-secondry group-hover:text-secondry">
											<ArrowUpRight
												size={24}
												strokeWidth={1.25}
											/>
						...
						<div className="w-full flex items-center overflow-hidden justify-center xm:hidden sm:hidden">
							<motion.p
								...
								className="paragraph opacity-50 font-Formiga text-secondry">
								scroll down
							</motion.p>
						</div>
					</div>
